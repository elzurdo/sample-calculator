...
def sample_rate_fpr_to_size(success_rate, max_fpr, success_rate_boundary=SUCCESS_RATE_BOUNDARY, max_sample_size=1000, d_sample = 5, tpr_method="flat_min", min_ab=0.5, generator_success_rates=None):
